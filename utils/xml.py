...
class Xml(object):
    def __init__(self, file_path, dec,):
        ...
        """
        template_path = os.path.join(BASE_DIR, "conf", "template.xml")  # xml模板路径
    ...
    def process_dec_head(self):
        fields = ["SeqNo", "IEFlag", "Type", "AgentCode", "AgentName", "ApprNo", "BillNo",
                  ...
                  "PDate", "TypistNo", "InputerName", "PartenerID", "TgdNo", "DataSource",
                  "DeclTrnRel", "ChkSurety", "BillType", "AgentCodeScc", "OwnerCodeScc", "TradeCodeScc",
                  "CopCodeScc", "PromiseItmes", "TradeAreaCode", "CheckFlow"]
