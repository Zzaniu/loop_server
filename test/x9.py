...
class Xml(object):
    def __init__(self, file_path, dec):
        ...
        """
        template_path = "template.xml"  # xml模板路径
        ...
        self.DecList = self.root.find(self.tag("DecList"))  # 一个item
    ...
    def _process_dec_list(self, dec_list):
        ...
        for i in fields:
            node = DecList.find(self.tag(i))
            node.text = dec_list.get(i, "")
